        ...
        <div className="prose prose-neutral max-w-none prose-headings:font-bold prose-a:text-blue-600">
          <section className="mb-12">
            ...
            <p className="text-lg text-black/70 mb-4">
              <strong>Context-Ly CLI</strong> is an open-source Context Intelligence Engine designed to help developers generate high-quality, token-efficient context for Large Language Models (LLMs).
            </p>
          ...
          <section className="mb-12">
            ...
            <div className="rounded-2xl border border-black/10 bg-white overflow-hidden shadow-sm">
              {[
                ...
                <div key={i} className="group flex flex-col sm:flex-row sm:items-center border-b border-black/5 last:border-0 hover:bg-black/[0.02] transition-colors">
