...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Context-Ly — The OS for AI context engineering" },
      { property: "og:description", content: "Stop wasting tokens. Start building context. Context-Ly turns messy thoughts into AI-ready context packs." },
